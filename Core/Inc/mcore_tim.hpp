...
enum class TimCh : uint8_t {None, CH1, CH2, CH3, CH4, CH5, CH6};

enum class TimOCPol : uint8_t{HIGH, LOW, NONE};

enum class TimIdleState : uint8_t{ RESET, SET, NONE};
...
enum class TimClkDiv : uint8_t{ DIV1  = 0b00, DIV2  = 0b01, DIV4  = 0b10 };
...
template<> inline void TIM_ClkEnable<TIM1>() { RCC::_APB2ENR::TIM1EN::set(); }
template<> inline void TIM_ClkEnable<TIM2>() { RCC::_APB1ENR::TIM2EN::set(); }
template<> inline void TIM_ClkEnable<TIM3>() { RCC::_APB1ENR::TIM3EN::set(); }
template<> inline void TIM_ClkEnable<TIM4>() { RCC::_APB1ENR::TIM4EN::set(); }
template<> inline void TIM_ClkEnable<TIM5>() { RCC::_APB1ENR::TIM5EN::set(); }
template<> inline void TIM_ClkEnable<TIM6>() { RCC::_APB1ENR::TIM6EN::set(); }
template<> inline void TIM_ClkEnable<TIM7>() { RCC::_APB1ENR::TIM7EN::set(); }
template<> inline void TIM_ClkEnable<TIM8>() { RCC::_APB2ENR::TIM8EN::set(); }
template<> inline void TIM_ClkEnable<TIM9>() { RCC::_APB2ENR::TIM9EN::set(); }
template<> inline void TIM_ClkEnable<TIM10>(){ RCC::_APB2ENR::TIM10EN::set();}
template<> inline void TIM_ClkEnable<TIM11>(){ RCC::_APB2ENR::TIM11EN::set();}
template<> inline void TIM_ClkEnable<TIM12>(){ RCC::_APB1ENR::TIM12EN::set();}
template<> inline void TIM_ClkEnable<TIM13>(){ RCC::_APB1ENR::TIM13EN::set();}
template<> inline void TIM_ClkEnable<TIM14>(){ RCC::_APB1ENR::TIM14EN::set();}


// ------------------- TIMER PROPERTIES (битовая маска) -------------------
struct TIM_properties {
    bool isAdvanced=false, hasOCM3=false, hasRepetition=false, hasClkDiv=false;
    TimCh chnl = TimCh::None;
};

template<typename TIMx> struct TimFlags;                        /*  ADV    OCM3   Repet  ClkDiv CHANNEL  */
template<> struct TimFlags<TIM1> {static constexpr TIM_properties f{true,  true,  true,  true,  TimCh::CH6}; };
template<> struct TimFlags<TIM2> {static constexpr TIM_properties f{false, true,  false, true,  TimCh::CH4}; };
template<> struct TimFlags<TIM3> {static constexpr TIM_properties f{false, true,  false, true,  TimCh::CH4}; };
template<> struct TimFlags<TIM4> {static constexpr TIM_properties f{false, true,  false, true,  TimCh::CH4}; };
template<> struct TimFlags<TIM5> {static constexpr TIM_properties f{false, true,  false, true,  TimCh::CH4}; };
template<> struct TimFlags<TIM6> {static constexpr TIM_properties f{false, false, false, false, TimCh::None}; };
template<> struct TimFlags<TIM7> {static constexpr TIM_properties f{false, false, false, false, TimCh::None}; };
template<> struct TimFlags<TIM8> {static constexpr TIM_properties f{true , true,  true,  true,  TimCh::CH6}; };
template<> struct TimFlags<TIM9> {static constexpr TIM_properties f{false, true,  false, true,  TimCh::CH2}; };
template<> struct TimFlags<TIM10>{static constexpr TIM_properties f{false, false, false, true,  TimCh::CH1}; };
template<> struct TimFlags<TIM11>{static constexpr TIM_properties f{false, false, false, true,  TimCh::CH1}; };
template<> struct TimFlags<TIM12>{static constexpr TIM_properties f{false, true,  false, true,  TimCh::CH2}; };
template<> struct TimFlags<TIM13>{static constexpr TIM_properties f{false, false, false, true,  TimCh::CH1}; };
template<> struct TimFlags<TIM14>{static constexpr TIM_properties f{false, false, false, true,  TimCh::CH1}; };
...
struct TimChannelTraits {
    ...
    static auto getCCMRType() {
        if constexpr      (Ch <= TimCh::CH2) return typename TIMx::_CCMR1_Output{};
        else if constexpr (Ch <= TimCh::CH4) return typename TIMx::_CCMR2_Output{};
        else                                 return typename TIMx::_CCMR3_Output{};
    }

    template<TimCh Ch>
    struct PolarityMaskHelper {
        static constexpr uint32_t value = []{
            if constexpr      (Ch == TimCh::CH1) return TIMx::_CCER::CC1P::BitMsk;
            else if constexpr (Ch == TimCh::CH2) return TIMx::_CCER::CC2P::BitMsk;
            else if constexpr (Ch == TimCh::CH3) return TIMx::_CCER::CC3P::BitMsk;
            else if constexpr (Ch == TimCh::CH4) return TIMx::_CCER::CC4P::BitMsk;
            else if constexpr (Ch == TimCh::CH5) return TIMx::_CCER::CC5P::BitMsk;
            else if constexpr (Ch == TimCh::CH6) return TIMx::_CCER::CC6P::BitMsk;
    ...
    struct EnableMaskHelper {
        static constexpr uint32_t value = []{
            if constexpr      (Ch == TimCh::CH1) return TIMx::_CCER::CC1E::BitMsk;
            else if constexpr (Ch == TimCh::CH2) return TIMx::_CCER::CC2E::BitMsk;
            else if constexpr (Ch == TimCh::CH3) return TIMx::_CCER::CC3E::BitMsk;
            else if constexpr (Ch == TimCh::CH4) return TIMx::_CCER::CC4E::BitMsk;
            else if constexpr (Ch == TimCh::CH5) return TIMx::_CCER::CC5E::BitMsk;
            else if constexpr (Ch == TimCh::CH6) return TIMx::_CCER::CC6E::BitMsk;
            else return uint32_t(0);
        }();
    };
   ...
   static constexpr uint32_t oc_mode_shift =
    ...
    static constexpr uint32_t preload_en_mask = 1 << 3;  // OCxPE
    static constexpr uint32_t fast_en_mask = 1 << 2;     // OCxFE
    ...
    static inline void write_ccr(uint32_t v) {
        if constexpr(ch == TimCh::CH1) TIMx::_CCR1::overwrite(v);
        else if constexpr(ch == TimCh::CH2) TIMx::_CCR2::overwrite(v);
        else if constexpr(ch == TimCh::CH3) TIMx::_CCR3::overwrite(v);
        else if constexpr(ch == TimCh::CH4) TIMx::_CCR4::overwrite(v);
        else if constexpr(ch == TimCh::CH5) TIMx::_CCR5::overwrite(v);
        else if constexpr(ch == TimCh::CH6) TIMx::_CCR6::overwrite(v);
    }
    ...
    static inline void set_idle(uint32_t& cr2, TimIdleState s, TimIdleState sn) {
...
static inline void TIM_PWM_ConfigChannel() {
    ...
    tmpccmr &= ~(Traits::oc_mode_mask | Traits::preload_en_mask | Traits::fast_en_mask);
    ...
    if constexpr((ch == TimCh::CH1 
               || ch == TimCh::CH2 
               || ch == TimCh::CH3) && TimFlags<TIMx>::f.isAdvanced) {
